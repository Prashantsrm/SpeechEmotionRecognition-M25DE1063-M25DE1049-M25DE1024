...
| File | Owner |
|------|-------|
| `src/features/extractor.py` | **Avinash** (primary), **Asit** (review & optimization) |

---

## 📋 Phase 4: Model Development & Training (~30 hours)

**Lead: Asit, Avinash and Prashant** (joint ownership as specified)
...
- **Trained multiple times** with different configurations:
  ...
  - Attempt 3: lr=0.001, batch=16 → best result (75.10% val accuracy)
...
- **System limitation**: CPU-only training limited us to 53 epochs (370m 56s per run)
- Best model saved automatically as `models/ensemble_best.pth`
- Final best validation accuracy: **75.10%**
...
| `train_ensemble_full.py` | **Asit,Avinash** |
...
**Lead: Asit, Avinash** | Support: Prashant
...
| `results/cross_dataset_evaluation.json` | Generated by Avinash |
